...
const ChatInput: FC<ChatInputProps> = ({chatPartner, chatId}) => {
  ...
  return <div className='border-t border-gray-200 px-4 pt-4 mb-2 sm:mg-0'>
...
className="block w-full resize-none border-0 bg-transparent text-gray-400 placeholder:text-gray-400 focus:ring-0 sm:py-1.5 sm:leading-6"
    />
