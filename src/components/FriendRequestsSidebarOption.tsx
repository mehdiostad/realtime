...
const FriendRequestsSidebarOption: FC<
  ...
  return (
    ...
    >
      <div className="text-gray-400 border-gray-200 group-hover:border-indigo-600 group-hover:text-indigo-600 flex h-6 shrink-0 items-center justify-center rounded-lg border text-[0.625rem] font-medium">
